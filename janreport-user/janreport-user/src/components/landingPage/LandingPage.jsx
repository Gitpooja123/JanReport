        ...
        <section id="hero" className="landing-section container">
          <div className="row align-items-center g-4">
            ...
            <div className="col-lg-5">
              <div
                className="rounded-4 shadow-lg overflow-hidden hero-image"
                style={{
                  background:
                    "linear-gradient(135deg, #0B4572, #157BC0, var(--color-accent))",
                }}
              >
                <div className="ratio ratio-4x3">
                  <img
                    src="/janreport-hero.png"
                    alt="Citizens using JanReport to raise civic issues"
                    className="img-fluid"
